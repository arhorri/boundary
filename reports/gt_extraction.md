...
- boundary pixel fraction after cleanup (min/median/max): 0.2498/0.3576/0.5205
...
| --- | --- | --- | --- | --- |
| `[75, 176, 40]` | no | 17/42 | 0.0031 | 0.0148 |
...
- boundary pixel fraction after cleanup (min/median/max): 0.0005/0.0927/0.2589
...
- boundary pixel fraction after cleanup (min/median/max): 0.0744/0.2235/0.3185
...
- boundary pixel fraction after cleanup (min/median/max): 0.0478/0.1028/0.2188
...
| colour | folded | present in | pixel frac (med) | share of boundary (med) |
| --- | --- | --- | --- | --- |
| `[75, 176, 40]` | no | 23/23 | 0.0169 | 0.2096 |
